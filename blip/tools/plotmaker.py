...
def cornermaker(post, params,parameters, inj, Model, Injection=None,
                ...
                mpl_settings={},tight_layout=False):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cornertight', action='store_true', help="Use plt.tight_layout() for the corner plots.")
    ...
    if not args.nocorner:
        ...
        cornermaker(post, params, parameters, inj, Model, Injection=Injection,
                    ...
                    mpl_settings=fmt,tight_layout=args.cornertight)
    if not args.nofit:
        ## reset the matplotlib style setting
        matplotlib.rcParams.update(matplotlib.rcParamsDefault)
